...
| Data          | Link/Source |
| ------------- | ------------- |
| **Metro Lines and Stations** | Metro lines data is from [metrolinemap.com](https://www.metrolinemap.com/). Scraped and parsed by [Dénes Csala Data Consulting](https://github.com/denesdata/kontext/tree/master/metro). Metro stations data is from [OpenStreetMap](https://www.openstreetmap.org/).|
